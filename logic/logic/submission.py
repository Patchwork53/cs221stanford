...
def formula2b():
    ...
    # BEGIN_YOUR_CODE (our solution is 1 line of code, but don't worry if you deviate from this)
    return Exists('$x', And(Person('$x'), Implies(Person('$x'), Forall('$y', Not(Child('$x','$y'))))))
    # END_YOUR_CODE
...
def formula2d():
    ...
    return Forall('$x', Forall('$y', Equiv(Grandmother('$x','$y'), Exists('$z', And(And(Parent('$x','$z'),Parent('$z','$y')), Female('$y'))   )    )))
     # END_YOUR_CODE
