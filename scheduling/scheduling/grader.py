...
def test1c_2():
    ...
    print(acSolver.optimalWeight)
    print(acSolver.numOptimalAssignments)
    print(acSolver.numOperations)
...
grader.addBasicPart('3b-1-basic', test3b_1, 2, maxSeconds=10000, description="Basic test for add_unit_constraints")
